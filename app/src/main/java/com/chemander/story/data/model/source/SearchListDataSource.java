...
public class SearchListDataSource extends PageKeyedDataSource<Integer, StoryInformation> {
    private StoryService storyService;

    public SearchListDataSource(){
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, StoryInformation> callback) {
        ...
        storyService.getSearchListStories(1, SettingsManager.SIZE_OF_PAGE, SettingsManager.queryOfSearch).enqueue(new Callback<GetStoriesInformation>() {
            @Override
